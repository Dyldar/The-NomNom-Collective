...
//imports flutters core UI components
...
//creates a reusable list tile for displaying food items
    ...
    child: Container(
      ...
      decoration: BoxDecoration(
        image: DecorationImage(
          //To display our logo images behind the texts(behind the recipes)
      ...
      child: Center(
        child: Text(
          //diisplaying the name of the meal
          mealName,
...
Widget build(BuildContext context) {
  ...
  return Scaffold(
    ...
    //adds space
    body: Padding(
      //the size of the padding symetriccally
      padding: EdgeInsets.symmetric(vertical: 7.5, horizontal: 20.0),
      child: ListView(
        children: [
          //creates the list tiles here
          ListTile(
            ...
            //you can tap it ,navigates to the search page
            onTap: () => Navigator.pushReplacement(context,
                MaterialPageRoute(builder: (context) => FoodSearchPage())),
          ),
          //to leave a space in between
          SizedBox(height: 7.5),
          SizedBox(height: 40,
          ...
          Container(
            ...
            child: SingleChildScrollView(
              //to swipe the tiles left and right (horizontaly)
            ...
            child: SingleChildScrollView(
              ...
              child: Row(
                children: [
                  ...
                  _customListTile('Stuffed Peppers', 'lib/Images/LuncDin.jpg'),
          ...
          Container(
            ...
            child: Column(
              ...
              children: [
                Text("Friendly Remaninder :)",
                  style: TextStyle(
                    fontSize: 18,
                    fontWeight: FontWeight.bold
                  ),
                ),
                Text("It is best for you to avoid the following foods!",
                  style: TextStyle(
                    fontWeight: FontWeight.bold
                  ),
                ),
